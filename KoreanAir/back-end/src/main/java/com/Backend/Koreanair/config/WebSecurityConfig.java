...
import com.backend.koreanair.security.filter.FilterSkipMatcher;
import com.backend.koreanair.security.filter.FormLoginFilter;
import com.backend.koreanair.security.filter.JwtAuthenticationFilter;
import com.backend.koreanair.security.hendler.FormLoginAuthenticationFailuerHandler;
import com.backend.koreanair.security.hendler.FormLoginAuthenticationSuccessHandler;
import com.backend.koreanair.security.hendler.JwtAuthenticationFailureHandler;
import com.backend.koreanair.security.jwt.HeaderTokenExtractor;
import com.backend.koreanair.security.provider.FormLoginAuthenticationProvider;
import com.backend.koreanair.security.provider.JwtAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private JwtAuthenticationFilter jwtFilter() throws Exception {
        ...
        skipPath.add("GET,/api/account/*");
        skipPath.add("POST,/api/university");
