        ...
        return (
            <Fragment>
                ...
                <MyPageWrap>
                    <MyPageLeft>
                        <ul>
                            <MyPageList active={page} onClick={() => this.handlePageChange("profile")}>프로필
                                편집</MyPageList>
                            <MyPageList active={page} onClick={() => this.handlePageChange("password")}>비밀번호
                                변경</MyPageList>
                            <MyPageList active={page}
                                        onClick={() => this.handlePageChange("repository")}>활동기록보기</MyPageList>
                            <MyPageList active={page} onClick={() => this.handlePageChange("likeRecord")}>좋아요한
                                푹찍</MyPageList>
                        </ul>
                    </MyPageLeft>
                    <MyPageRight>
